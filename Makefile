...
train:
	...
	uv run accelerate launch train.py \
		--output_dir outputs/japanese-hubert-base-phoneme-ctc-v3 \
		...
		--push_to_hub \
		--hub_model_id prj-beatrice/japanese-hubert-base-phoneme-ctc-v3
	@echo "✅ 学習フロー終了"
...
# Hubモデルのプロセッサー修正
# 例: make fix-hub-model HUB_MODEL=prj-beatrice/japanese-hubert-base-phoneme-ctc-v3 BASE_MODEL=rinna/japanese-hubert-base
fix-hub-model:
ifndef HUB_MODEL
	$(error HUB_MODEL変数を指定してください。例: make fix-hub-model HUB_MODEL=prj-beatrice/japanese-hubert-base-phoneme-ctc-v3)
endif
	@echo "🛠️ Hubモデルを修正します..."
